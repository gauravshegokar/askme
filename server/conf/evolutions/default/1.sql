...
create table channel_post (
  ...
  constraint pk_channel_post primary key (channel_channel_id,post_post_id)
);
...
alter table channel_post add constraint fk_channel_post_channel foreign key (channel_channel_id) references channel (channel_id) on delete restrict on update restrict;
create index ix_channel_post_channel on channel_post (channel_channel_id);

alter table channel_post add constraint fk_channel_post_post foreign key (post_post_id) references post (post_id) on delete restrict on update restrict;
create index ix_channel_post_post on channel_post (post_post_id);
...
alter table channel_post drop foreign key fk_channel_post_channel;
drop index ix_channel_post_channel on channel_post;

alter table channel_post drop foreign key fk_channel_post_post;
drop index ix_channel_post_post on channel_post;
